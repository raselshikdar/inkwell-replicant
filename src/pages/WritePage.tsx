...
const WritePage = () => {
  ...
  const handlePublish = () => {
    ...
    setPublishing(true);
    // Mock publish — navigate back to home
    setTimeout(() => {
      navigate("/");
    }, 1000);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-50 bg-card border-b border-border">
        <div className="max-w-[900px] mx-auto px-4 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="rounded-full text-xs" onClick={handlePublish} disabled={!title.trim() || publishing}>
      ...
      <div className="max-w-[720px] mx-auto px-4 py-8">
        ...
        <textarea
          ...
          className="w-full text-3xl font-extrabold text-foreground placeholder:text-muted-foreground/50 bg-transparent border-none outline-none resize-none mb-4"
          rows={2}
        />
        ...
        <div className="flex flex-wrap items-center gap-2 mb-6">
          ...
          {tags.length < 5 && (
            <input
              ...
              placeholder="Add tag..."
              className="text-sm bg-transparent text-foreground placeholder:text-muted-foreground outline-none w-24"
            />
          )}
        </div>
